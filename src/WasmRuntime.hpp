...
public:
    ...
    wasm_func_t* CreateExportFunction(const std::string& name, wasm_func_callback_with_env_t func, void* env, wasm_valtype_vec_t* params, wasm_valtype_vec_t* results);
